...
public class QTGKPSPublicSoap
{
    ...
    public QTGKPSPublicSoap()
    {
    }

    public QTGKPSPublicSoap(String url)
    {
        this.url=url;
    }

    public QTGKPSPublicSoap (String url,QTGConnectionProvider connectionProvider) {
        this.url=url;
    ...
    {
        QTGRequestResultHandler handler = new QTGRequestResultHandler(QTGSoapVersion.v1_1);
        return handler;
    }
