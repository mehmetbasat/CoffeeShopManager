...
public class QTGKPSPublicSoap12
{
    ...
    private QTGConnectionProvider connectionProvider=new QTGHttpConnectionProvider();

    public QTGKPSPublicSoap12()
    {
    }

    public QTGKPSPublicSoap12(String url)
    {
        this.url=url;
    }

    public QTGKPSPublicSoap12 (String url,QTGConnectionProvider connectionProvider) {
        this.url=url;
    ...
    protected QTGRequestResultHandler createRequestResultHandler()
    {
        QTGRequestResultHandler handler = new QTGRequestResultHandler(QTGSoapVersion.v1_2);
        return handler;
    }
    
    private org.w3c.dom.Document createTCKimlikNoDogrulaRequest(final Long TCKimlikNo,final String Ad,final String Soyad,final Integer DogumYili,QTGRequestResultHandler __handler) throws java.lang.Exception
    {
    ...
    {
        QTGRequestResultHandler __handler =createRequestResultHandler();
        ...
        org.w3c.dom.Node __result=QTGHelper.getResult(__handler.getOutputBody(), "TCKimlikNoDogrulaResult",false);
        if(__result!=null)
        {
            return QTGHelper.toBoolFromString(((org.w3c.dom.Element)__result).getTextContent());
        }
        return null;
    }
    protected void sendRequest(String soapAction,org.w3c.dom.Document soapBody, QTGRequestResultHandler handler) throws java.lang.Exception
    {
        ...
        String __requestBody=QTGHelper.getStringFromDocument(soapBody);
        if(enableLogging)
        {
            System.out.println("requestDump: "+__requestBody);
        }
        QTGResponseData response=connectionProvider.sendRequest(url,__requestBody, __headers,handler);
        if(enableLogging)
        {
